...
export default function Expenses() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Build additional expenses with custom_category (free text), matching AdditionalExpenseCreate schema
      const additionalExpenses = showAdditional && additionalCategory && additionalAmount
        ? [{
